  ...
  module API
    class Account < Vk::Schema::Namespace
      ...
      class AccountCounters < Vk::Schema::Object
        ...
        attribute :messages, API::Types::Coercible::Int.optional
        ...
        attribute :events, API::Types::Coercible::Int.optional
        # @return [Integer] New groups number
        attribute :groups, API::Types::Coercible::Int.optional
        # @return [Integer] New notifications number
        attribute :notifications, API::Types::Coercible::Int.optional
        # @return [Integer] New app_requests number
        attribute :app_requests, API::Types::Coercible::Int.optional
      end
    end
  end
end
