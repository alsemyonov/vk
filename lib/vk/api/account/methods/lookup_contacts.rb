    ...
    class Account < Vk::Schema::Namespace
      module Methods
        ...
        class LookupContacts < Schema::Method
          ...
          attribute :contacts, API::Types::Coercible::Array.optional
