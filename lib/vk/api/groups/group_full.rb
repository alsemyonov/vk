  ...
  module API
    class Groups < Vk::Schema::Namespace
      ...
      class GroupFull < API::Groups::Group
        ...
        attribute :market, Dry::Types[API::Groups::MarketInfo].optional
        # @return [Integer] Current user's member status
        attribute :member_status, API::Types::Coercible::Int.optional
        ...
        attribute :is_subscribed, API::Base::BoolInt.optional
        ...
        attribute :wiki_page, API::Types::Coercible::String.optional
        ...
        attribute :counters, Dry::Types[API::Groups::CountersGroup].optional
        ...
        attribute :fixed_post, API::Types::Coercible::Int.optional
        # @return [API::Base::BoolInt] Information whether current user can create topic
        attribute :can_create_topic, API::Base::BoolInt.optional
        # @return [API::Base::BoolInt] Information whether current user can upload video
        attribute :can_upload_video, API::Base::BoolInt.optional
        ...
        attribute :links, API::Types::Coercible::Array.member(API::Groups::LinksItem).optional
        # @return [Array] @see https://github.com/VKCOM/vk-api-schema/blob/master/objects.json
        attribute :contacts, API::Types::Coercible::Array.member(API::Groups::ContactsItem).optional
        ...
        attribute :main_section, API::Types::Coercible::Int.optional
        # @return [Integer] Information whether current user can send a message to community
        attribute :can_message, API::Types::Coercible::Int.optional
        ...
        attribute :finish_date, API::Types::Coercible::Int.optional
