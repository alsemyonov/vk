    ...
    class Photos < Vk::Schema::Namespace
      module Methods
        ...
        class GetAll < Schema::Method
          ...
          attribute :no_service_albums, API::Types::Bool.optional.default(nil)
          # @return [Boolean] '1' – to show information about photos being hidden from the block above the wall.
          attribute :need_hidden, API::Types::Bool.optional.default(nil)
          ...
          attribute :skip_hidden, API::Types::Bool.optional.default(nil)
        end
      end
    end
  end
