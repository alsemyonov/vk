    ...
    class Photos < Vk::Schema::Namespace
      module Methods
        ...
        class Edit < Schema::Method
          ...
          attribute :place_str, API::Types::Coercible::String.optional
          # @return [String] @see https://github.com/VKCOM/vk-api-schema/blob/master/objects.json
          attribute :foursquare_id, API::Types::Coercible::String.optional
          # @return [Boolean] @see https://github.com/VKCOM/vk-api-schema/blob/master/objects.json
          attribute :delete_place, API::Types::Bool.optional
        end
      end
    end
  end
