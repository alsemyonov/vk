  ...
  module API
    class Photos < Vk::Schema::Namespace
      ...
      class PhotoAlbumFull < Vk::Schema::Object
        ...
        attribute :thumb_id, API::Types::Coercible::Int.optional
