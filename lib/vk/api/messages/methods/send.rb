    ...
    class Messages < Vk::Schema::Namespace
      module Methods
        ...
        class Send < Schema::Method
          ...
          attribute :attachment, API::Types::Coercible::String.optional
          ...
          attribute :forward_messages, API::Types::Coercible::String.optional
          ...
          attribute :notification, API::Types::Bool.optional
        end
      end
    end
  end
