  ...
  module API
    class Wall < Vk::Schema::Namespace
      ...
      class WallpostFull < Vk::Schema::Object
        ...
        attribute :copy_history, API::Types::Coercible::Array.member(API::Wall::Wallpost).optional
        ...
        attribute :can_pin, API::Types::Coercible::Int.optional
        # @return [Integer] Information whether the post is pinned
        attribute :is_pinned, API::Types::Coercible::Int.optional
