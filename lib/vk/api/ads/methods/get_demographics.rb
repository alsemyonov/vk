  ...
  module API
    class Ads < Vk::Schema::Namespace
      module Methods
        ...
        class GetDemographics < Schema::Method
          # @!group Properties

          self.open = false
          self.method = 'ads.getDemographics'
          ...
          #   @return [Ads::Methods::GetDemographics]

          # @!group Arguments

          # @return [Integer] Advertising account ID.
          attribute :account_id, API::Types::Coercible::Int.optional
          # @return [String] Type of requested objects listed in 'ids' parameter:; *ad — ads;; *campaign — campaigns.;
          attribute :ids_type, API::Types::Coercible::String.optional
          # @return [String] IDs requested ads or campaigns, separated with a comma, depending on the value set in 'ids_type'. Maximum 2000 objects.
          ...
          attribute :period, API::Types::Coercible::String.optional
